        ...
        get() {
          ...
          return (l =
            (n = this.renderRoot) === null || n === void 0
              ? void 0
              : n.querySelector(r)) !== null && l !== void 0
            ? l
            : null;
        },
        enumerable: !0,
              ...
              (this[n] =
                (h =
                  (l = this.renderRoot) === null || l === void 0
                    ? void 0
                    : l.querySelector(r)) !== null && h !== void 0
                  ? h
                  : null),
            this[n]
          );
...
var L;
((L = window.HTMLSlotElement) === null || L === void 0
  ? void 0
  : L.prototype.assignedElements) != null
  ? (r, t) => r.assignedElements(t)
  : (r, t) =>
      r.assignedNodes(t).filter((e) => e.nodeType === Node.ELEMENT_NODE);
var I = {
  ...
  dependencies: { '@dotlottie/common': 'workspace:*', lit: '^2.7.5' },
  devDependencies: {
...
var a = class extends b {
  ...
  _parseLoop(t) {
    ...
    return Number.isInteger(e) && e > 0
      ? ((this._loop = e), e)
      : typeof t == 'string' && ['true', 'false'].includes(t)
      ? ((this._loop = t === 'true'), this._loop)
      : (c('loop must be a positive integer or a boolean'), !1);
  }
  _handleSeekChange(t) {
  ...
  _initListeners() {
    ...
    (this._unsubscribeListeners = t.state.subscribe((e$1, i) => {
      (this._seeker = e$1.seeker),
        this.requestUpdate(),
        i.currentState !== e$1.currentState &&
          this.dispatchEvent(new CustomEvent(e$1.currentState)),
        this.dispatchEvent(
          new CustomEvent(e.Frame, {
            detail: { frame: e$1.frame, seeker: e$1.seeker },
          })
        ),
        this.dispatchEvent(
          new CustomEvent(e.VisibilityChange, {
            detail: { visibilityPercentage: e$1.visibilityPercentage },
          })
        );
    })),
      ...
      t.addEventListener('DOMLoaded', () => {
        ...
        e$1 &&
          e$1.themes &&
          (this._themesForCurrentAnimation = e$1.themes.filter((i) =>
            i.animations.includes(this.getCurrentAnimationId() || '')
          )),
          e$1 &&
            e$1.states &&
            ((this._hasMultipleStates = e$1.states.length > 0),
            (this._statesForCurrentAnimation = []),
            e$1.states.forEach((i) => {
      ...
      window &&
        window.addEventListener('click', (e) => this._clickOutListener(e));
  }
  async load(t, e, i) {
    if (!this.shadowRoot) return;
    this._dotLottieCommonPlayer && this._dotLottieCommonPlayer.destroy(),
      (this._dotLottieCommonPlayer = new j(t, this.container, {
        rendererSettings:
          e != null
            ? e
            : {
    ...
    (this._hasMultipleAnimations = this.animationCount() > 1),
      n &&
        (n.themes &&
          ((this._themesForCurrentAnimation = n.themes.filter((l) =>
            l.animations.includes(this.getCurrentAnimationId() || '')
          )),
  ...
  getCurrentAnimationId() {
    var t;
    return (t = this._dotLottieCommonPlayer) == null
      ? void 0
  ...
  animationCount() {
    ...
    return (
      (this._dotLottieCommonPlayer &&
        ((t = this._dotLottieCommonPlayer.getManifest()) == null
          ? void 0
          : t.animations.length)) ||
      0
    );
  ...
  snapshot(t = !0) {
    ...
    if (t) {
      ...
      (n.href = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(i)}`),
  ...
  async firstUpdated() {
    var t;
    (this.container =
      (t = this.shadowRoot) == null ? void 0 : t.querySelector('#animation')),
      'IntersectionObserver' in window &&
        ((this._io = new IntersectionObserver((e) => {
          var i, n;
          e[0] !== void 0 && e[0].isIntersecting
            ? ((i = this._dotLottieCommonPlayer) == null
                ? void 0
                : i.currentState) === f.Frozen && this.play()
            : ((n = this._dotLottieCommonPlayer) == null
                ? void 0
                : n.currentState) === f.Playing && this._freeze();
        })),
  ...
  disconnectedCallback() {
    ...
    this._io && (this._io.disconnect(), (this._io = void 0)),
      ...
      (e = this._unsubscribeListeners) == null || e.call(this),
      window &&
        window.removeEventListener('click', (i) => this._clickOutListener(i));
  }
  _clickOutListener(t) {
    !t
      .composedPath()
  ...
  renderControls() {
    ...
    let t =
        ((i = this._dotLottieCommonPlayer) == null
          ? void 0
          : i.currentState) === f.Playing,
      e =
        ((n = this._dotLottieCommonPlayer) == null
          ? void 0
          : n.currentState) === f.Paused;
    return a$3`
      <div id="lottie-controls" aria-label="lottie-animation-controls" class="toolbar">
        ...
        <input
          ...
          class="seeker ${
            ((l = this._dotLottieCommonPlayer) == null
              ? void 0
              : l.direction) === -1
              ? 'to-left'
              : ''
        ...
        <button
          ...
          class=${
            (h = this._dotLottieCommonPlayer) != null && h.loop
        ...
        this._popoverIsOpen
          ? a$3`
            ...
            >
              ...
              ${
                this._styleTabIsOpen
                  ? a$3`<div class="option-title-themes-row">
                      <button
                      ...
                      >
                        ...
                        ${
                          ((b = this._dotLottieCommonPlayer) == null
                            ? void 0
                            : b.defaultTheme) === ''
                            ? a$3``
                            : a$3`
      ...
      <div id="animation-container" class=${t} lang="en" role="img" aria-label="lottie-animation-container">
        <div id="animation" class=${e} style="background:${this.background};">
          ${
            ((i = this._dotLottieCommonPlayer) == null
              ? void 0
              : i.currentState) === f.Error
              ? a$3` <div class="error">⚠️</div> `
              : void 0
          }
        </div>
...
a$1([p({ type: String })], a.prototype, 'defaultTheme', 2),
  a$1([O('#animation')], a.prototype, 'container', 2),
  a$1([p()], a.prototype, 'playMode', 2),
  a$1([p({ type: Boolean })], a.prototype, 'autoplay', 2),
  a$1([p({ type: String })], a.prototype, 'background', 2),
  a$1([p({ type: Boolean })], a.prototype, 'controls', 2),
  a$1([p({ type: Number })], a.prototype, 'direction', 2),
  a$1([p({ type: Boolean })], a.prototype, 'hover', 2),
  a$1([p({ type: String })], a.prototype, 'loop', 2),
  a$1([p({ type: String })], a.prototype, 'renderer', 2),
  a$1([p({ type: Number })], a.prototype, 'speed', 2),
  a$1([p({ type: String })], a.prototype, 'src', 2),
  a$1([p()], a.prototype, 'intermission', 2),
  a$1([p({ type: String })], a.prototype, 'activeAnimationId', 2),
  a$1([p({ type: Boolean })], a.prototype, 'light', 2),
  a$1([p({ type: Boolean })], a.prototype, 'worker', 2),
  a$1([p({ type: String })], a.prototype, 'activeStateId', 2),
  a$1([k()], a.prototype, '_seeker', 2);
customElements.get(T) ||
  customElements.define(T, a); /*! Bundled license information:
